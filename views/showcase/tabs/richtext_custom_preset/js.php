...
humhub.module('demo.richtext.preset', function (module, require, $) {
    ...
    // Define a custom underline plugin
    let underline = {
        id: 'underline',
        // Define a new schema item
        schema: {
            marks: {
                underline: {
                    parseDOM: [{tag: "u"}],
        ...
        // This will overwrite the default render behaviour of single `_` markup when rendering the output
    ...
    // Register the new plugin and our custom preset, the new plugin will only be added to our own preset.
