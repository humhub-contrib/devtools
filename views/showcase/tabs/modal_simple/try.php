<form class="form-horizontal">
    <div class="form-group">
        <label for="simple-modal-header" class="col-sm-1 control-label">
    ...
    <div class="form-group">
        <label for="simple-modal-body" class="col-sm-1 control-label">
    ...
    <div class="form-group">
        <label for="simple-modal-footer" class="col-sm-1 control-label">
    ...
    <div class="form-group">
        <div class="col-sm-offset-1 col-sm-11">
            <div class="checkbox">
                <label>
                    <input type="checkbox" checked="checked" id="simple-modal-backdrop">
    ...
    <div class="form-group">
        <div class="col-sm-offset-1 col-sm-11">
            <button class="btn btn-default" id="simple-modal-open"><?= Yii::t('DevtoolsModule.views_showcase_tabs_simple_modal_try', 'open'); ?></button>
        </div>
    </div>
</form>
