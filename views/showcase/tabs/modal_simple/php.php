...
<form class="form-horizontal">
    <div class="mb-3 row">
        <label for="simple-modal-header" class="col-sm-1 form-label text-end pt-2"><?= Yii::t('DevtoolsModule.views_showcase_tabs_simple_modal_try', 'Header'); ?></label>
        <div class="col-sm-11">
    ...
    <div class="mb-3 row">
        <label for="simple-modal-body" class="col-sm-1 form-label text-end pt-2"><?= Yii::t('DevtoolsModule.views_showcase_tabs_simple_modal_try', 'Body'); ?></label>
        <div class="col-sm-11">
    ...
    <div class="mb-3 row">
        <label for="simple-modal-footer" class="col-sm-1 form-label text-end pt-2"><?= Yii::t('DevtoolsModule.views_showcase_tabs_simple_modal_try', 'Footer'); ?></label>
        <div class="col-sm-11">
    ...
    <div class="mb-3 row">
        <div class="offset-sm-1 col-sm-11">
            <div class="form-check">
                ...
                <label class="form-check-label"><?= Yii::t('DevtoolsModule.views_showcase_tabs_simple_modal_try', 'Closable by backdrop click and keyboard'); ?></label>
            </div>
        </div>
    </div>
    <div class="mb-3 row">
        <div class="offset-sm-1 col-sm-11">
            <button class="btn btn-light" id="simple-modal-open">Open</button>
        </div>
    </div>
</form>
